...
public class MinimizingMakeChangeFitnessFunction extends FitnessFunction {
    ...
    public double evaluate(IChromosome a_subject) {
        ...
        // higher fitness values higher (e.g .DefaultFitnessEvaluator). Or it
        // could weight lower fitness values higher, because the fitness value
        // is seen as a defect rate (e.g. DeltaFitnessEvaluator)
